  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
      {thinkingMessage && !currentTool && (
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 12px', background: 'var(--accent-soft)', border: '1px solid rgba(52,163,123,0.2)', borderRadius: 8, fontSize: 13 }}>
      ...
      >
        {expanded ? (
          <>
            ...
            <div style={{ padding: '12px 16px', borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexShrink: 0 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                <div style={{ width: 28, height: 28, borderRadius: 6, background: 'var(--accent)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 13, fontWeight: 800, color: 'var(--accent-ink)', flexShrink: 0 }}>A</div>
                <span style={{ fontFamily: '"Fraunces", serif', fontWeight: 600, fontSize: 15, color: 'var(--fg)', whiteSpace: 'nowrap' }}>GroundedIQ</span>
              </div>
            ...
            <div style={{ padding: '12px 12px 4px', flexShrink: 0 }}>
              <button
                onClick={onNewChat}
                style={{ width: '100%', display: 'flex', alignItems: 'center', gap: 8, padding: '8px 12px', background: 'var(--accent-soft)', border: '1px solid rgba(52,163,123,0.2)', borderRadius: 8, cursor: 'pointer', color: 'var(--accent)', fontSize: 13, fontWeight: 500 }}
              >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8, padding: '12px 0' }}>
            <div style={{ width: 28, height: 28, borderRadius: 6, background: 'var(--accent)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 13, fontWeight: 800, color: 'var(--accent-ink)' }}>A</div>
                        ...
                        >
                          ...
                          <div
                            style={{
                              ...
                              border: `1px solid ${isUser ? 'rgba(52,163,123,0.3)' : 'var(--border)'}`,
                          ...
                          <div
                            style={{
                              ...
                              border: `1px solid ${isUser ? 'rgba(52,163,123,0.2)' : 'var(--border)'}`,
                              fontSize: 14,
                              color: 'var(--fg)',
                              lineHeight: 1.6,
                            }}
                ...
                <div style={{ position: 'relative', maxWidth: 800, margin: '0 auto' }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      display: 'flex', alignItems: 'center', justifyContent: 'center',
                      color: message.trim() ? 'var(--accent-ink)' : 'var(--fg-muted)',
              ...
              {analysisResult.assumptions.length > 0 ? (
                <div>
                  ...
                  {analysisResult.assumptions.map((a, i) => (
                    <div key={i} style={{ padding: '10px 12px', background: 'var(--accent-soft)', border: '1px solid rgba(52,163,123,0.18)', borderRadius: 8, marginBottom: 6, display: 'flex', justifyContent: 'space-between', gap: 8 }}>
